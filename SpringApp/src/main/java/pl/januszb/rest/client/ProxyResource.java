...
public class ProxyResource {
	private String endpointUrl = "http://localhost:8080/sapp/api/server/isAliveSecure";
	...
	/**
	 * The purpose of the initialisation method is to modify the SSLContext and
	 * provide it to the HttpsURLConnection class. This will allow us to make
	 * SSL calls without using a trusted certificate which for testing purposes
	 * will suffice.
	 */
	public void initSSL() {
		try {
